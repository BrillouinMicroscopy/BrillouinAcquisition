...
void BrillouinAcquisition::readSettings() {
	...
	m_BrillouinSettings.xMin = settings.value("stage-x-min", m_BrillouinSettings.xMin).toInt();
	m_BrillouinSettings.xMax = settings.value("stage-x-max", m_BrillouinSettings.xMax).toInt();
	m_BrillouinSettings.xSteps = settings.value("stage-x-steps", m_BrillouinSettings.xSteps).toInt();
	m_BrillouinSettings.yMin = settings.value("stage-y-min", m_BrillouinSettings.yMin).toInt();
	m_BrillouinSettings.yMax = settings.value("stage-y-max", m_BrillouinSettings.yMax).toInt();
	m_BrillouinSettings.ySteps = settings.value("stage-y-steps", m_BrillouinSettings.ySteps).toInt();
	m_BrillouinSettings.zMin = settings.value("stage-z-min", m_BrillouinSettings.zMin).toInt();
	m_BrillouinSettings.zMax = settings.value("stage-z-max", m_BrillouinSettings.zMax).toInt();
	m_BrillouinSettings.zSteps = settings.value("stage-z-steps", m_BrillouinSettings.zSteps).toInt();
